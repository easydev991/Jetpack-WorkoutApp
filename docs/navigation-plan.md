...
- **Иерархия маршрутов**: каждый маршрут имеет parentTab для отслеживания вложенности
...
- ✅ `AppState.kt` - класс для управления состоянием навигации и авторизации
  ...
  - Отслеживание текущего назначения и вкладки
...
4. **Для навигации**: Продолжить использовать единый AppState на уровне RootScreen
...
5. **Документация**: отсутствует документация по использованию навигации в новых экранах
