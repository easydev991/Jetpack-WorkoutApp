...
### ⚠️ Кнопка удаления профиля в TopAppBar (в разработке)
...
**UI**:
- Кнопка: иконка корзины в `actions` TopAppBar
- Диалог подтверждения:
  - Заголовок: "Удаление профиля" / "Delete profile"
  - Сообщение: "Все данные вашего профиля будут необротимо удалены" / "All your profile data will be permanently deleted"
  - Кнопки: "Отмена" / "Cancel" и "Удалить" / "Delete"
