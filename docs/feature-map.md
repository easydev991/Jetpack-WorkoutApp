...
- Для получения доступа ко всем возможностям приложения необходимо авторизоваться, а
  зарегистрироваться можно на [сайте](https://workout.su)
...
- Просмотр детальной информации о площадке (название, размер, тип, снепшот карты, список
  тренирующихся *, фотографии, автор, комментарии)
...
- Просмотр детальной информации о мероприятии (название, дата и место проведения, снепшот карты,
  список участников *, фотографии, описание, организатор, комментарии)
...
- Настроить оформление приложения
- Отправить обратную связь о приложении по email
- Оценить приложение в RuStore
