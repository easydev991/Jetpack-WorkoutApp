...
- **Разделение моделей** - 17 API моделей + 4 доменные модели + 12 UI моделей vs ~7 в nowinandroid
...
- Построен полностью на Jetpack Compose с Material Design 3
- Навигация через Navigation Compose с 5 вкладками: Parks, Events, Messages, Profile, More
- Состояние навигации управляется через AppState
- BottomNavigationBar для навигации между вкладками
- **Pull-to-Refresh**: реализован на экране профиля с Material3 `PullToRefreshBox`
...
**Примечание:** Строковые ресурсы находятся в `app/src/main/res/values/` и `app/src/main/res/values-ru/`
