...
class JournalEntryDaoTest {
     ...
     */
    @Test
    fun testGetJournalEntriesByJournalId_returnsEmpty() =
        runTest {
     ...
     */
    @Test
    fun testGetJournalEntriesByJournalId_returnsEntries() =
        runTest {
     ...
     */
    @Test
    fun testGetJournalEntriesByJournalId_ordersByModifyDateDesc() =
        runTest {
            // Given - вставляем записи с разными датами изменения
            val entriesWithDifferentDates =
                listOf(
                    createTestJournalEntryEntity(
                        id = 1L,
     ...
     */
    @Test
    fun testInsertAll_insertsEntries() =
        runTest {
     ...
     */
    @Test
    fun testInsertAll_upsertsEntries() =
        runTest {
     ...
     */
    @Test
    fun testDeleteByJournalId_deletesAll() =
        runTest {
     ...
     */
    @Test
    fun testDeleteByJournalId_doesNotDeleteOtherJournals() =
        runTest {
            ...
            val journal1Result =
                journalEntryDao.getJournalEntriesByJournalId(testJournalId1).first()
            val journal2Result =
                journalEntryDao.getJournalEntriesByJournalId(testJournalId2).first()
     ...
     */
    @Test
    fun testGetJournalEntriesByJournalId_emitsUpdates() =
        runTest {
     ...
     */
    @Test
    fun testDeleteById_deletesEntry() =
        runTest {
     ...
     */
    @Test
    fun testDeleteById_doesNotDeleteOtherEntries() =
        runTest {
            // Given - вставляем записи
            val testEntries =
                listOf(
     ...
     */
    @Test
    fun testDeleteById_nonExistentEntry() =
        runTest {
            // Given - вставляем записи
            val testEntries =
                listOf(
