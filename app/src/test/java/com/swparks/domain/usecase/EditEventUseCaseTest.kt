...
class EditEventUseCaseTest {
    ...
    private val testForm = EventForm(
    ...
    @Test
    fun invoke_success_returnsEvent() = runTest {
        coEvery {
    ...
    @Test
    fun invoke_withPhotos_returnsEvent() = runTest {
    ...
    @Test
    fun invoke_differentEventId_passesCorrectId() = runTest {
    ...
    private fun createTestEvent(id: Long): Event = Event(
        id = id,
        title = "Обновлённая тренировка",
        description = "Новое описание",
        ...
        isCurrent = true,
        photos = emptyList(),
        author = com.swparks.data.model.User(id = 1L, name = "Автор", image = null),
        name = "event"
    )
}
