...
class JournalEntriesRepositoryImplTest {
     ...
     */
    @Test
    fun testObserveJournalEntries_returnsFlowFromDao() =
        runTest {
            // Given
            val mockEntities =
                listOf(
            ...
            every { mockJournalEntryDao.getJournalEntriesByJournalId(testJournalId) } returns
                flowOf(
                    mockEntities
                )
     ...
     */
    @Test
    fun testRefreshJournalEntries_success_savesToDb() =
        runTest {
            // Given
            val mockResponses =
                listOf(
     ...
     */
    @Test
    fun testRefreshJournalEntries_success_deletesOldEntries() =
        runTest {
            // Given
            val mockResponses =
                listOf(
     ...
     */
    @Test
    fun testRefreshJournalEntries_error_returnsFailure() =
        runTest {
            // Given
     ...
     */
    @Test
    fun testRefreshJournalEntries_emptyList_savesEmpty() =
        runTest {
            // Given
     ...
     */
    @Test
    fun testRefreshJournalEntries_logsSuccess() =
        runTest {
            // Given
            val mockResponses =
                listOf(
     ...
     */
    @Test
    fun testRefreshJournalEntries_logsError() =
        runTest {
            // Given
     ...
     */
    @Test
    fun testObserveJournalEntries_mapsToDomain() =
        runTest {
            // Given
            val mockEntity =
     ...
     */
    @Test
    fun testObserveJournalEntries_mapsMultipleEntitiesToDomain() =
        runTest {
            // Given
            val mockEntities =
                listOf(
     ...
     */
    @Test
    fun testObserveJournalEntries_handlesNullValuesInEntity() =
        runTest {
            // Given
            val mockEntity =
                createMockJournalEntryEntity(
     ...
     */
    @Test
    fun testDeleteJournalEntry_success_deletesFromDb() =
        runTest {
            // Given
            val testEntryId = 1L
     ...
     */
    @Test
    fun testDeleteJournalEntry_success204_deletesFromDb() =
        runTest {
            // Given
            val testEntryId = 1L
     ...
     */
    @Test
    fun testDeleteJournalEntry_404_deletesFromDbAndReturnsSuccess() =
        runTest {
            // Given
            val testEntryId = 1L
     ...
     */
    @Test
    fun testDeleteJournalEntry_401_returnsFailure() =
        runTest {
            // Given
            val testEntryId = 1L
     ...
     */
    @Test
    fun testDeleteJournalEntry_403_returnsFailure() =
        runTest {
            // Given
            val testEntryId = 1L
     ...
     */
    @Test
    fun testDeleteJournalEntry_ioException_returnsFailure() =
        runTest {
            // Given
            val testEntryId = 1L
            val exception = IOException("Connection timeout")
     ...
     */
    @Test
    fun testDeleteJournalEntry_logsSuccess() =
        runTest {
            // Given
            val testEntryId = 1L
            val successResponse: Response<Unit> = Response.success(Unit)
     ...
     */
    @Test
    fun testCanDeleteEntry_noEntries_returnsTrue() =
        runTest {
            // Given
            val testEntryId = 1L
     ...
     */
    @Test
    fun testRefreshJournalEntries_httpException_returnsFailure() =
        runTest {
            // Given
     ...
     */
    @Test
    fun testRefreshJournalEntries_httpException401_returnsFailure() =
        runTest {
            // Given
            val mockResponse = mockk<Response<*>>(relaxed = true)
     ...
     */
    @Test
    fun testDeleteJournalEntry_httpException_returnsFailure() =
        runTest {
            // Given
            val testEntryId = 1L
            val mockResponse = mockk<Response<*>>(relaxed = true)
