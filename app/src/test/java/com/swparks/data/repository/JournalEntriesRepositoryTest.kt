...
class JournalEntriesRepositoryTest {
    ...
    @Test
    fun observeJournalEntries_whenDaoReturnsEntries_thenReturnsDomainEntries() = runTest {
        // Given
    ...
    @Test
    fun refreshJournalEntries_whenApiReturnsEntries_thenSavesToDatabase() = runTest {
        // Given
    ...
    @Test
    fun refreshJournalEntries_whenApiReturnsEmptyList_thenClearsDatabase() = runTest {
        // Given
