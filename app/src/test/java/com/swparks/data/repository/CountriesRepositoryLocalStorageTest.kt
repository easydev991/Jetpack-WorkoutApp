...
class CountriesRepositoryLocalStorageTest {
    ...
    @Test
    fun whenLocalFileDoesNotExist_seedIsCopiedFromAssets() = runTest {
        every { mockAssetManager.open("countries.json") } returns ByteArrayInputStream(
    ...
    @Test
    fun whenLocalFileExists_seedIsNotCopiedAgain() = runTest {
        val localFile = File(tempDir, "countries.json")
    ...
    @Test
    fun countriesAreReadFromLocalJsonFile() = runTest {
        val localFile = File(tempDir, "countries.json")
        localFile.writeText(testCountriesJson)
    ...
    @Test
    fun updateCountriesFromServer_savesToLocalFileAtomically() = runTest {
        val localFile = File(tempDir, "countries.json")
        localFile.writeText(testCountriesJson)
    ...
    @Test
    fun afterUpdateFromServer_countriesFlowReturnsUpdatedData() = runTest {
        val localFile = File(tempDir, "countries.json")
        localFile.writeText(testCountriesJson)
    ...
    @Test
    fun getCountryById_searchesInLocalFileData() = runTest {
        val localFile = File(tempDir, "countries.json")
        localFile.writeText(testCountriesJson)
    ...
    @Test
    fun getCityById_searchesInLocalFileData() = runTest {
        val localFile = File(tempDir, "countries.json")
        localFile.writeText(testCountriesJson)
    ...
    @Test
    fun getCitiesByCountry_returnsCorrectCities() = runTest {
        val localFile = File(tempDir, "countries.json")
        localFile.writeText(testCountriesJson)
    ...
    @Test
    fun updateCountriesFromServer_onSuccess_updatesCacheAndSavesFile() = runTest {
        val localFile = File(tempDir, "countries.json")
        localFile.writeText(testCountriesJson)
    ...
    @Test
    fun updateCountriesFromServer_onNetworkError_doesNotUpdateCache() = runTest {
        val localFile = File(tempDir, "countries.json")
        localFile.writeText(testCountriesJson)
    ...
    @Test
    fun firstLaunch_loadsFromAssetsAndSavesToLocalFile() = runTest {
        every { mockAssetManager.open("countries.json") } returns ByteArrayInputStream(
            testCountriesJson.toByteArray()
        )
