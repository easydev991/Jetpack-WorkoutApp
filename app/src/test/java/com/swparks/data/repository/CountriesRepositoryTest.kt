...
class CountriesRepositoryTest {
    ...
    @Test
    fun testGetCountriesFlow_returnsCachedCountries() =
        runTest {
            // Given
    ...
    @Test
    fun testGetCountryById_existingId_returnsCountry() =
        runTest {
            // Given
            val inputStream = ByteArrayInputStream(testCountriesJson.toByteArray())
            every { mockAssetManager.open("countries.json") } returns inputStream
    ...
    @Test
    fun testGetCountryById_nonExistingId_returnsNull() =
        runTest {
            // Given
            val inputStream = ByteArrayInputStream(testCountriesJson.toByteArray())
            every { mockAssetManager.open("countries.json") } returns inputStream
    ...
    @Test
    fun testGetCityById_existingId_returnsCity() =
        runTest {
            // Given
            val inputStream = ByteArrayInputStream(testCountriesJson.toByteArray())
            every { mockAssetManager.open("countries.json") } returns inputStream
    ...
    @Test
    fun testGetCityById_nonExistingId_returnsNull() =
        runTest {
            // Given
            val inputStream = ByteArrayInputStream(testCountriesJson.toByteArray())
            every { mockAssetManager.open("countries.json") } returns inputStream
    ...
    @Test
    fun testGetCitiesByCountry_returnsCorrectCities() =
        runTest {
            // Given
            val inputStream = ByteArrayInputStream(testCountriesJson.toByteArray())
            every { mockAssetManager.open("countries.json") } returns inputStream
    ...
    @Test
    fun testGetCitiesByCountry_nonExistingCountry_returnsEmptyList() =
        runTest {
            // Given
            val inputStream = ByteArrayInputStream(testCountriesJson.toByteArray())
            every { mockAssetManager.open("countries.json") } returns inputStream
    ...
    @Test
    fun testUpdateCountriesFromServer_success() =
        runTest {
            // Given
            val inputStream = ByteArrayInputStream(testCountriesJson.toByteArray())
            every { mockAssetManager.open("countries.json") } returns inputStream
    ...
    @Test
    fun testUpdateCountriesFromServer_networkError() =
        runTest {
            // Given
            val inputStream = ByteArrayInputStream(testCountriesJson.toByteArray())
            every { mockAssetManager.open("countries.json") } returns inputStream
    ...
    @Test
    fun testUpdateCountriesFromServer_httpError() =
        runTest {
            // Given
            val inputStream = ByteArrayInputStream(testCountriesJson.toByteArray())
            every { mockAssetManager.open("countries.json") } returns inputStream
    ...
    @Test
    fun testCountriesFlow_afterUpdateFromServer_returnsUpdatedData() =
        runTest {
            // Given
            val inputStream = ByteArrayInputStream(testCountriesJson.toByteArray())
            every { mockAssetManager.open("countries.json") } returns inputStream
    ...
    @Test
    fun testCountriesFlow_loadingFromAssetsError_doesNotCrash() =
        runTest {
    ...
    @Test
    fun testGetCountriesFlow_multipleCalls_loadsAssetsOnlyOnce() =
        runTest {
            // Given
            val inputStream = ByteArrayInputStream(testCountriesJson.toByteArray())
            every { mockAssetManager.open("countries.json") } returns inputStream
