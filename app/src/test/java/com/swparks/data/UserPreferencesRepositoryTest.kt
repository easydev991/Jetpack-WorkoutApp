...
class UserPreferencesRepositoryTest {
    ...
    @Test
    fun isAuthorized_whenNoUserIdStored_thenReturnsFalse() =
        runTest {
            // Given
    ...
    @Test
    fun isAuthorized_whenIOExceptionOccurs_thenEmitsEmptyPreferencesAndReturnsFalse() =
        runTest {
            // Given
            val mockDataStore = mockk<DataStore<Preferences>>()
    ...
    @Test
    fun isAuthorized_whenOtherExceptionOccurs_thenThrowsException() =
        runTest {
            // Given
            val mockDataStore = mockk<DataStore<Preferences>>()
    ...
    @Test
    fun lastParksUpdateDate_whenNoDateStored_thenReturnsDefaultDate() =
        runTest {
            val mockDataStore = mockk<DataStore<Preferences>>()
            every { mockDataStore.data } returns flowOf(emptyPreferences())
            val repository = UserPreferencesRepository(mockDataStore)
    ...
    @Test
    fun lastParksUpdateDate_whenDateStored_thenReturnsStoredDate() =
        runTest {
            val mockDataStore = mockk<DataStore<Preferences>>()
    ...
    @Test
    fun lastParksUpdateDate_whenIOExceptionOccurs_thenReturnsDefaultDate() =
        runTest {
            val mockDataStore = mockk<DataStore<Preferences>>()
            every { mockDataStore.data } returns flow { throw IOException("Test error") }
            val repository = UserPreferencesRepository(mockDataStore)
    ...
    @Test
    fun lastCountriesUpdateDate_whenNoDateStored_thenReturnsDefaultDate() =
        runTest {
            val mockDataStore = mockk<DataStore<Preferences>>()
            every { mockDataStore.data } returns flowOf(emptyPreferences())
            val repository = UserPreferencesRepository(mockDataStore)
    ...
    @Test
    fun lastCountriesUpdateDate_whenDateStored_thenReturnsStoredDate() =
        runTest {
            val mockDataStore = mockk<DataStore<Preferences>>()
            val preferences =
                mutablePreferencesOf(lastCountriesUpdateDateKey to "2025-02-20T15:45:00Z")
            every { mockDataStore.data } returns flowOf(preferences)
            val repository = UserPreferencesRepository(mockDataStore)
    ...
    @Test
    fun lastCountriesUpdateDate_whenIOExceptionOccurs_thenReturnsDefaultDate() =
        runTest {
            val mockDataStore = mockk<DataStore<Preferences>>()
            every { mockDataStore.data } returns flow { throw IOException("Test error") }
            val repository = UserPreferencesRepository(mockDataStore)
    ...
    @Test
    fun setLastParksUpdateDate_callsEditOnDataStore() =
        runTest {
    ...
    @Test
    fun setLastCountriesUpdateDate_callsEditOnDataStore() =
        runTest {
            val mockDataStore = mockk<DataStore<Preferences>>(relaxed = true)
            every { mockDataStore.data } returns flowOf(emptyPreferences())
            val repository = UserPreferencesRepository(mockDataStore)
