...
class SearchUserViewModelTest {
    ...
    @Test
    fun onSearch_withEmptyQuery_doesNotCallApi_andRemainsInitial() = runTest {
        // Given
    ...
    @Test
    fun onSearch_withShortQuery_doesNotCallApi_andRemainsInitial() = runTest {
        // Given
    ...
    @Test
    fun onSearch_success_setsSuccessState() = runTest {
        // Given
        val query = "test"
    ...
    @Test
    fun onSearch_emptyResult_setsEmptyState() = runTest {
        // Given
        val query = "notfound"
        viewModel.searchQuery.value = query
    ...
    @Test
    fun onSearch_networkError_setsNetworkErrorState() = runTest {
        // Given
        val query = "test"
        viewModel.searchQuery.value = query
    ...
    @Test
    fun onSearch_loadingState_duringRequest() = runTest {
        // Given
        val query = "test"
        viewModel.searchQuery.value = query
    ...
    @Test
    fun onSearch_whileLoading_ignoresNewSearch() = runTest {
        // Given
        val query1 = "test1"
        val query2 = "test2"
        var callCount = 0
    ...
    @Test
    fun onSearch_sameQuery_afterSuccess_ignoresSearch() = runTest {
        // Given
        val query = "test"
        viewModel.searchQuery.value = query
    ...
    @Test
    fun onSearch_differentQuery_afterSuccess_executesNewSearch() = runTest {
        // Given
        val query1 = "test1"
        val query2 = "test2"
        viewModel.searchQuery.value = query1
        coEvery { swRepository.findUsers(query1) } returns Result.success(listOf(testUser))
        coEvery { swRepository.findUsers(query2) } returns Result.success(
    ...
    @Test
    fun onUserClick_logsUserId() = runTest {
        // Given
        val userId = 123L
