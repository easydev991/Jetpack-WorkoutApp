...
class Integration404Test {
     ...
     */
    @Test
    fun parkDetail_404_whenParkNotFound_deletesAndUpdatesParksList() =
        runTest {
     ...
     */
    @Test
    fun eventDetail_404_whenEventNotFound_deletesAndUpdatesEventsList() =
        runTest {
            val testDispatcher = StandardTestDispatcher(testScheduler)
            Dispatchers.setMain(testDispatcher)
