...
class UserNotifierImplTest {
    ...
    @Test
    fun handle_error_logs_network_error() =
        runTest {
    ...
    @Test
    fun handle_error_logs_network_error_with_throwable() =
        runTest {
    ...
    @Test
    fun handle_error_logs_validation_error() =
        runTest {
    ...
    @Test
    fun handle_error_logs_server_error() =
        runTest {
    ...
    @Test
    fun handle_error_logs_generic_error() =
        runTest {
    ...
    @Test
    fun handle_error_logs_generic_error_with_throwable() =
        runTest {
    ...
    @Test
    fun handle_error_returns_true_when_emitted_successfully() =
        runTest {
    ...
    @Test
    fun show_info_returns_true_when_emitted_successfully() =
        runTest {
            val message = "Операция успешно выполнена"
